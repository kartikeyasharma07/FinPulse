...
This fetches ~1 year of price history + current fundamentals for the 20 tracked
companies from yfinance and stores them in Supabase. Takes a few minutes.
Re-run it any time you want fresher data.
